...
public:
	...
	bool load(const PlugInModifierLoaderContext &context, const Data::SPQR::PanningModifier &data);
...
private:
	...
	PlugInModifierFactory<PanningModifier, Data::SPQR::PanningModifier> _panningModifierFactory;
};
